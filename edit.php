...
body { background: url("photos/fiend.jpg") repeat-x top center; color:#555;}
...
<div style="border:1px solid #fff; width: 300px;height:240; background:#fff;">					
<form name="my_form" method="post" action="edit.php">
  ...
  <p><br />
      <textarea onKeyPress=check_length(this.form); onKeyDown=check_length(this.form); name="quote" rows="4" cols="30" style="width: 300px; height:180; color: #fff; background-color: #333; border:none;"></textarea>
...
$quote = $_POST['quote'];
{
$sql2 = "UPDATE members SET quote='$quote' WHERE username='$user'";
